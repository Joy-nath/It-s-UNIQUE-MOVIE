# (c) [Htan Yoj] @MOVIE_HOUSE11
# (s) @techmasterz , @techmastrz_Group, @techmasterz
# Copyright permission under MIT License
# All rights reserved by DarkLord

import asyncio, aiofiles, aiofiles.os, datetime, traceback, random, string, time, os
from pyrogram import Client as MovieTime_robot, filters as filter
from MovieTime_Robot.database.users_chats_db import db
from MovieTime_Robot.database._utils import send_msg
from random import choice
from config import ADMINS

class config(object):
    broadcast_ids = {} # don't change this..!!
# https://github.com/Joy-nath/Broadcast-Bot

@uniquemovie_robot.on_message(filter.private & filter.command(["broadcast", "send"]) & filter.user(ADMINS) & filter.reply)
