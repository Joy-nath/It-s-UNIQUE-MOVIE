import logging
from pyrogram import Client as MovieTime_Robot, filters as Worker, emoji
from pyrogram.types import InlineKeyboardButton, InlineKeyboardMarkup, InlineQueryResultCachedDocument
from MovieTime_Robot.database._utils import get_size, is_subscribed
from MovieTime_Robot.database.autofilter_db import get_search_results
...
@MovieTime_Robot.on_inline_query(Worker.user(AUTH_USERS) if AUTH_USERS else None)
...
def get_reply_markup(query):
    buttons = [[
        InlineKeyboardButton('Support Group', url='https://t.me/+duhVEZ0In603OWVl'),
